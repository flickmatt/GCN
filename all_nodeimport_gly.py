...
csv_folder = "/Users/M254284/Desktop/Neo4j_Projects/Img_events/ML/GCN_GARO/Glycolytic"
...
for filename in os.listdir(csv_folder):
    ...
    cypher_query = f"""
    LOAD CSV WITH HEADERS FROM 'file:///Glycolytic/{filename}' AS row
    ...
    SET n.event = row.event,
        ...
        n.percentage_glycolytic = row.percentage_glycolytic,
